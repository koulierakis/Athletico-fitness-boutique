...
The first premium functional version is intentionally not production-ready until the final owner review and remaining authentic-data checks are complete.
...
- [ ] Replace static mailto contact transport with an approved form endpoint if required.
- [ ] Add member/app preview only from verified current Athletico content.
- [ ] Complete final visual QA in a real browser on desktop, laptop, tablet and mobile before merge.

## Non-negotiable content rule

Do not add any reference to the obsolete floor-area figure anywhere in visible copy, SEO metadata, alt text, structured data, footer, hidden content or future copy.

Do not merge this branch or change production deployment without owner approval.
